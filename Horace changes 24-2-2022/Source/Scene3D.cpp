...
bool CScene3D::Init(std::string initGameLevel)
{
	...
	cSoundController->LoadSound(FileSystem::getPath("Sounds\\Heart_Beat_Normal.ogg"), 4, true);
	cSoundController->LoadSound(FileSystem::getPath("Sounds\\Heart_Beat_Fast.ogg"), 5, true);
	cSoundController->LoadSound(FileSystem::getPath("Sounds\\horror-atmosphere-background.ogg"), 6, true, true);
