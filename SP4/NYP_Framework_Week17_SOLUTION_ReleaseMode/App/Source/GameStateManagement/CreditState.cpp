...
bool CCreditState::Init(void)
{
	...
	background = new CBackgroundEntity("Image/Background/creditImage.png");
 ...
 */
bool CCreditState::Update(const double dElapsedTime)
{
 ...
 */
void CCreditState::Destroy(void)
{
	// Disable the cursor
	if (CSettings::GetInstance()->bDisableMousePointer == true)
