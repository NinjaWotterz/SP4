 ...
 */
CWoodenCrate3D::CWoodenCrate3D(void)
 ...
 */
CWoodenCrate3D::CWoodenCrate3D(const glm::vec3 vec3Position,
 ...
 */
void CWoodenCrate3D::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CWoodenCrate3D::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CWoodenCrate3D::SetProjection(const glm::mat4 projection)
{
 ...
 */
void CWoodenCrate3D::AttachCamera(CCamera* cCamera)
{
 ...
 */
bool CWoodenCrate3D::IsCameraAttached(void)
{
	if (cCamera)
		return true;
	return false;
 ...
 */
void CWoodenCrate3D::ProcessRotate(const float fXOffset)
{
	// Update the yaw
 ...
 */
bool CWoodenCrate3D::Update(const double dElapsedTime)
{
 ...
 */
void CWoodenCrate3D::PreRender(void)
{
 ...
 */
void CWoodenCrate3D::Render(void)
{
	// If this entity is not active, then skip this
	if (bStatus == false)
	{
 ...
 */
void CWoodenCrate3D::PostRender(void)
{
	// If this entity is not active, then skip this
	if (bStatus == false)
	{
 ...
 */
void CWoodenCrate3D::Constraint(void)
{
	// Get the new height
 ...
 */
void CWoodenCrate3D::UpdateFrontAndYaw(void)
{
