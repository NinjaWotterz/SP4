 ...
 */
CMossrock3D::CMossrock3D(const glm::vec3 vec3Position,
...
bool CMossrock3D::Init(void)
{
	...
	std::string file_path = "Models/rock/mossrock.obj";
	...
	iTextureID = CImageLoader::GetInstance()->LoadTextureGetID("Models/rock/mossrock.tga", false);
	if (iTextureID == 0)
	{
 ...
 */
void CMossrock3D::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CMossrock3D::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CMossrock3D::SetProjection(const glm::mat4 projection)
{
...
*/
void CMossrock3D::SetInstancingMode(const bool bInstancedRendering)
{
 ...
 */
void CMossrock3D::SetNumOfInstance(const unsigned int iNumOfInstance)
{
 ...
 */
void CMossrock3D::SetSpreadDistance(const float fSpreadDistance)
{
 ...
 */
bool CMossrock3D::Update(const double dElapsedTime)
{
	if (!bInstancedRendering)
	{
...
*/
void CMossrock3D::PreRender(void)
{
...
*/
void CMossrock3D::PostRender(void)
{
...
/**
 @brief Print Self
 */
void CMossrock3D::PrintSelf(void)
{
	cout << "CMossrock3D::PrintSelf()" << endl;
	cout << "========================" << endl;
}
