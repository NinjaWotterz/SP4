 ...
 */
CZombie3D::CZombie3D(	const glm::vec3 vec3Position,
...
bool CZombie3D::Init(void)
{
	...
	std::string file_path = "Models/Enemy/zombie.obj";
 ...
 */
void CZombie3D::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CZombie3D::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CZombie3D::SetProjection(const glm::mat4 projection)
{
 ...
 */
void CZombie3D::AttachCamera(CCamera* cCamera)
{
 ...
 */
bool CZombie3D::IsCameraAttached(void)
{
	if (cCamera)
		return true;
	return false;
 ...
 */
void CZombie3D::SetWeapon(const int iSlot, CWeaponInfo* cWeaponInfo)
{
	if (iSlot == 0)
 ...
 */
CWeaponInfo* CZombie3D::GetWeapon(void) const
{
	if (iCurrentWeapon == 0)
...
/**
 ...
 @param iSlot A const int variable which contains the weapon info to check for. 0 == Primary, 1 == Secondary
 */
void CZombie3D::SetCurrentWeapon(const int iSlot)
{
...
/**
 ...
 @return A bool value
 */
bool CZombie3D::DischargeWeapon(void) const
{
 ...
 */
void CZombie3D::ProcessMovement(const ENEMYMOVEMENT direction, const float deltaTime)
{
 ...
 */
void CZombie3D::ProcessRotate(const float fXOffset)
{
	// Update the yaw
 ...
 */
bool CZombie3D::Update(const double dElapsedTime)
{
	...
	case FSM::IDLE:
		...
		//if (cCamera->GetInstance()->vec3Right.x <= 0)
		//{
		//	cout << "Looking" << endl;
		//}
 ...
 */
void CZombie3D::PostRender(void)
{
	// If this entity is not active, then skip this
	if (bStatus == false)
	{
 ...
 */
void CZombie3D::UpdateEnemyVectors(void)
{
 ...
 */
void CZombie3D::Constraint(void)
{
	// Get the new height
 ...
 */
void CZombie3D::UpdateFrontAndYaw(void)
{
